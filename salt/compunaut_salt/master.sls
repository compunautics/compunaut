/etc/salt/master.d/fileserver_backends.conf:
  file.managed:
    - source: salt://compunaut_salt/config/fileserver_backends.conf
    - user: root
    - group: root
    - mode: 0644
...
/etc/salt/master.d/gitfs.conf:
  file.managed:
    - source: salt://compunaut_salt/config/gitfs.conf
    - user: root
    - group: root
    - mode: 0644
...
/etc/salt/master.d/master_tuning.conf:
  file.managed:
    - source: salt://compunaut_salt/config/master_tuning.conf
    - user: root
    - group: root
    - mode: 0644
...
/etc/salt/master.d/mine.conf:
  file.managed:
    - source: salt://compunaut_salt/config/master.d_mine.conf
    - user: root
    - group: root
    - mode: 0644
